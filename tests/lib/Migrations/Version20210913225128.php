...
final class Version20210913225128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `rules` (id INT AUTO_INCREMENT NOT NULL, rules VARCHAR(255), schedule INT, PRIMARY KEY(id))');
        $this->addSql('ALTER TABLE `rules` ADD FOREIGNKEY schedule REFERENCES `schedules`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT;');
    }
